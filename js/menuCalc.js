...
function CalculateVegetarian(){
    var totalVeg = 0;
       ...
       totalVeg = totalVeg + itemID1.value * itemID1.getAttribute("data-price") + itemID2.value * itemID2.getAttribute("data-price");
...
function CalculateNonVeg(){
    ...
    for (let i = 3; i <= 7; i++) {
       itemID =document.getElementById("qtt" + i);
       totalNonVeg = totalNonVeg + itemID.value * itemID.getAttribute("data-price");
        
    }
    document.getElementById('non-vegetarian').innerHTML = "€" + totalNonVeg.toFixed(2);
}
